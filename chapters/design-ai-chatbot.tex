...
\textit{Chatfuel} là một công cụ tạo chatbot mạnh mẽ giúp xây dựng nhanh một chatbot trên mạng xã hội Facebook (hay Facebook Messenger). Chatfuel mạnh mẽ không chỉ ở giao diện trực quan, mà còn ở việc hỗ trợ JSON dành cho việc mở rộng thuật toán bằng lập trình.\par
...
\begin{figure}[htb!]\centering
	...
	\caption{Giao diện chức năng Re-engage}
