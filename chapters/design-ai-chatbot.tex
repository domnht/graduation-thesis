...
\begin{figure}[htb!]\centering
	\includegraphics[width=12cm]{chatfuel/demo-item-block}
	\caption{Một câu hỏi được nhập vào Chatfuel}
	\label{fig:fig-c3-demo-item-block}
\end{figure}\par

\subsection{Thêm các chức năng giao tiếp cho Kant bot}
\subsubsection{Các tin nhắn chào hỏi}

\subsubsection{Phần khảo sát ý kiến người dùng}
