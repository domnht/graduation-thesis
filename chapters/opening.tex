...
\begin{enumerate}[label=\textbf{\thesection.\arabic*.},align=left,left=0cm..1cm]
	...
	\item Tìm hiểu các lý thuyết đánh giá và đo lường trong giáo dục.
...
\begin{enumerate}[label=\textbf{\thesection.\arabic*.},align=left,left=0cm..1cm]
	\item \textbf{Về phương pháp:} giới hạn sử dụng nền tảng Chatbot của mạng xã hội Facebook, ngôn ngữ lập trình PHP, một số thuật toán ML và lý thuyết ứng đáp câu hỏi IRT.\par
