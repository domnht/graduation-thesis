...
Để sử dụng được ngân hàng CH cho việc đánh giá riêng lẻ từng học sinh theo \textit{lý thuyết ứng đáp câu hỏi} (IRT), cần chuẩn hóa mỗi CH theo các tham số \textit{độ khó} ($b$) và \textit{độ phân biệt} ($a$) – là những tham số độc lập so với mẫu TS. Phần lớn các câu hỏi trong luận văn này được tổng hợp từ \cite{luyen2018xay} và \cite{truc2018xay}. Trong đó có 44 CH có thể sử dụng ngay (đã được thực nghiệm và phân tích bằng IATA) có số lượng cụ thể như sau:\par
...
\begin{enumerate}[label=\textbf{Câu \arabic*.},align=left,left=0cm..0cm,itemindent=*]
	% Quy tắc đếm
	\item Mỗi ngày T đều đi từ nhà (vị trí $A$) tới trường (vị trí $D$) được nối với nhau như hình vẽ bên dưới. T có bao nhiêu con đường có thể đi và không đi qua một vị trí 2 lần?\par {\centering\includegraphics[width=9cm]{item-illustrations/G1-Q9}\par}
...
\begin{enumerate}[label=\textbf{Câu \arabic*.},align=left,left=0cm..0cm,itemindent=*]
	...
	{\centering\includegraphics[width=10cm]{item-illustrations/G1-Q43}\par}
...
\begin{enumerate}[label=\textbf{Câu \arabic*.},align=left,left=0cm..0cm,itemindent=*]
	...
	{\centering\includegraphics[width=4cm]{item-illustrations/G2-Q30}\par}
	...
	{\centering\includegraphics[width=10cm]{item-illustrations/G2-Q58}\par}
	\begin{enumerate}[label=\textbf{\Alph*.},align=left,left=1cm..0cm,itemindent=*]
	...
	{\centering\includegraphics[width=7cm]{item-illustrations/G2-Q127}\par}
...
Mục tiêu của cho ngân hàng CH chương Tổ hợp – Xác suất lớp 11 là tổng hợp khoảng 100 CH cho thuộc các chủ đề. Do đó, đề tài thực hiện thực nghiệm thêm 60 CH (được lựa chọn từ \cite{luyen2018xay} và \cite{truc2018xay}), có số lượng cụ thể như sau:\par
\begin{longtable}{SlScScScScSc}
	\multicolumn{1}{Sc}{\textbf{Chủ đề}} & \textbf{Mức độ 1} & \textbf{Mức độ 2} & \textbf{Mức độ 3} & \textbf{Mức độ 4} & \textbf{Tổng cộng}\\\hline\endhead\hline\endfoot
...
\begin{enumerate}[label=\textbf{Câu \arabic*.},align=left,left=0cm..0cm,itemindent=*]
	...
	{\centering\includegraphics[width=8cm]{item-illustrations/G1-Q10}\par}
	\begin{multicols}{4}\begin{enumerate}[label=\textbf{\Alph*.},align=left,left=1cm..0cm,itemindent=*]
	...
	{\centering\includegraphics[width=10cm]{item-illustrations/G2-Q17}\par}
	...
	{\centering\includegraphics[width=4cm]{item-illustrations/G2-Q96}\par}
	\begin{enumerate}[label=\textbf{\Alph*.},align=left,left=1cm..0cm,itemindent=*]
...
\begin{enumerate}[label=\textbf{Câu \arabic*.},align=left,left=0cm..0cm,itemindent=*]
	...
	{\centering\includegraphics[width=9cm]{item-illustrations/G1-Q39}\par}
