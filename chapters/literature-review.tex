...
Khái niệm về AI có thể được nhìn nhận theo nhiều cách khác nhau, chưa có định nghĩa nào được thừa nhận chung. Trên thế giới hiện có nhiều định nghĩa về trí tuệ nhân tạo, (\cite{nguyen2018tri}) tổng hợp 03 định nghĩa nổi bật:
\begin{itemize}
...
\subsection{Thực trạng nghiên cứu lĩnh vực trí tuệ nhân tạo}
...
\subsection{Các xu hướng phát triển trí tuệ nhân tạo}
...
(\cite{hoang2011ung}) Chia chatbot thành 3 nhóm chính:
\begin{itemize}
...
Với những tiềm năng nội tại, chatbot có thể được ứng dụng rộng rãi trong nhiều tình huống, đặc biệt là giáo dục – thông qua việc tương tác liên tục với người học, và lưu trữ quá trình, kết quả học tập, hỗ trợ cho việc theo dõi của người dạy. Dưới đây là các thành tựu đã đạt được của chatbot trong giáo dục:
...
\subsubsection{Trợ giảng cho giáo viên}
...
\subsubsection{Chương trình học cá nhân hóa}
...
Mô hình Rasch chỉ biểu diễn CH qua tham số \textit{độ khó} của CH. Phát biểu của ông trong (\cite{rasch1993probabilistic}) có giá trị như một tiền đề làm cơ sở cho mô hình của ông:\par
...
\end{figure}\par
Mô hình đường cong ĐTCH 2 và 3 tham số do Birnbaum đề xuất đầu tiên trong (\cite{birnbaum1968some}), nên đôi khi được gọi là các mô hình Birnbaum.

\subsubsection{Mô hình đặc trưng của câu hỏi dạng đường cong tích lũy vòm chuẩn}\label{sssec:duong-cong-tich-luy}
...
\subsection{Điểm thực và đường cong đặc trưng của đề trắc nghiệm}
