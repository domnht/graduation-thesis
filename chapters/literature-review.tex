...
Khái niệm về AI có thể được nhìn nhận theo nhiều cách khác nhau, chưa có định nghĩa nào được thừa nhận chung. Trên thế giới hiện có nhiều định nghĩa về trí tuệ nhân tạo, \parencite{nguyen2018tri} tổng hợp 03 định nghĩa nổi bật:
\begin{itemize}
...
\end{figure}\par
% Mô hình đường cong ĐTCH 2 và 3 tham số do \textcite{birnbaum1968some} đề xuất nên đôi khi được gọi là các mô hình Birnbaum.
