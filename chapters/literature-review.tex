...
% Hình \ref{fig:fig-s1-1-AI-timeline} tóm tắt quá trình phát triển AI từ năm 1943 tới nay qua 10 mốc quan trọng.
% \begin{figure}[ht]\centering\footnotesize
% 	\begin{tikzpicture}[scale=0.8]
% 		\draw [ultra thick, ->] (1,0) -- (21,0);
% 		\foreach \x/\year/\pos in {1/{1943 – 1955}/above, 2/1956/below, 3/{1952 – 1969}/above, 4/{1966 – 1973}/below, 5/{1969 – 1979}/above, 6/{1980 – nay}/below, 7/{1986 – nay}/above, 8/{1987 – nay}/below, 9/{1995 – nay}/above, 10/{2001 – nay}/below}
% 			\draw [fill=black] (2*\x, 0) circle (3pt) node [\pos] {\year};
% 	\end{tikzpicture}
% 	\caption{Các mốc phát triển quan trọng của lĩnh vực AI}
% 	\label{fig:fig-s1-1-AI-timeline}
% \end{figure}\par
